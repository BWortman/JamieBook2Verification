...
namespace WebApi2Book.Web.Api.Tests.Controllers.V1
{
    public class TasksControllerDependencyBlockMock : Mock<ITasksControllerDependencyBlock>
    {
        ...
        {
            get { return _addTaskMaintenanceProcessorMock ??
        ...
        {
            get { return _taskByIdInquiryProcessorMock ??
        ...
        {
            get { return _updateTaskMaintenanceProcessorMock ??
        ...
        {
            get { return _pagedDataRequestFactoryMock ??
        ...
        {
            get { return _allTasksInquiryProcessorMock ??
